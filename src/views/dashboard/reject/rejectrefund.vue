          ...
          <v-card class="mx-auto" elevation="15">
            <v-card-text>
              <v-row>
                ...
                <v-col cols="12" sm="4" md="4" lg="4">
                  <label class="font-weight-bold"
                    >Student's Name: {{ datarefund[0].studentname }}</label
                  >
                </v-col>
                <v-col cols="6" xs="4" sm="6" md="6" lg="6" align="center">
                  <label class="body-1 font-weight-bold"
                    >Student's ID: {{ datarefund[0].studentid }}</label
                  >
                </v-col>
                <v-col cols="6" xs="4" sm="6" md="6" lg="6" align="center">
                  <label class="body-1 font-weight-bold"
                    >Grade Level: {{ datarefund[0].grade }}</label
                  >
                </v-col>
                ...
                <v-col cols="12" xs="12" sm="12" md="12" lg="12">
                  <p class="body-1">
                    With my reason for request: {{ datarefund[0].reason1 }}
                    {{ datarefund[0].reasons2 }}
                  </p>
                </v-col>
                <v-col cols="12" xs="12" sm="12" md="12" lg="12">
                  <p class="body-1">
                    Refund Request for : {{ datarefund[0].amount }}
                  </p>
                </v-col>
                <v-col cols="12" xs="12" sm="12" md="12" lg="12">
                  <p class="body-1">
              ...
              <v-row>
                <v-col cols="6" xs="4" sm="6" md="6" lg="6" align="center">
                  <label class="body-1 font-weight-bold"
                    >Bank Name : {{ datarefund[0].bankname }}</label
                  >
                </v-col>
                <v-col cols="6" xs="4" sm="6" md="6" lg="6" align="center">
                  <label class="body-1 font-weight-bold"
                    >Branch: {{ datarefund[0].branch }}</label
                  >
                </v-col>
                <v-col cols="6" xs="4" sm="6" md="6" lg="6" align="center">
                  <label class="body-1 font-weight-bold"
                    >Account No.: {{ datarefund[0].account_no }}</label
                  >
                </v-col>

                <v-col cols="6" xs="4" sm="6" md="6" lg="6" align="center">
                  <label class="body-1 font-weight-bold"
                    >Account Name: {{ datarefund[0].account_name }}</label
                  >
                </v-col>
                <v-col cols="12" xs="12" sm="12" md="12" lg="12">
                ...
                <v-col cols="6" xs="4" sm="6" md="6" lg="6" align="center">
                  <label class="body-1 font-weight-bold"
                    >Phone number: {{ datarefund[0].phone_number }}</label
                  >
                </v-col>
                <v-col cols="6" xs="4" sm="6" md="6" lg="6" align="center">
                  <label class="body-1 font-weight-bold"
                    >E-mail: {{ datarefund[0].email }}</label
                  >
                </v-col>
                ...
                <v-col cols="6" xs="4" sm="6" md="6" lg="6" align="center">
                  <label class="body-1 font-weight-bold"
                    >Parent's Name : {{ datarefund[0].parent_name }}</label
                  >
                </v-col>
              ...
              <div>
                <v-row justify="center">
                  ...
                  <v-btn class="mx-2" color="red" dark
                   @click="reject()"
                    >Reject
...
export default {
  ...
  methods: {
    async reject() {
      confirm("คุณต้องการ Reject ใช่หรือไม่");
      const response = await refund
        .rejectrefund(
          {
            uuidrefund: this.$route.params.uuids,
      ...
      if (response.data.success) {
        confirm("Rejectสำเร็จแล้วค่ะ");
        this.$router.push({
          name: "refunddas",
        });
      } else {
        confirm("ทำการ Reject ไม่สำเร็จคะ");
      }
    },
  },
};
